...
- To add some structure to the output for better appearance, we can create a list of dictionaries to store the IP and MAC addresses of the devices that responded to the ARP request. We can then print this list in a user-friendly format.
...
- Executing this the output would look something like this:

  ```shell
  Network Scanner — target: 192.168.0.107/24
  Last scan: 2026-08-22 03:52:09
  Next scan in 10s (Ctrl+C to stop)
