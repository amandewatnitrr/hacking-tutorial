...
import Portscanner from './Pages/Python_for_Hacking/Portscanner' 
...
const Sidebar = () => {
  ...
  const lessons = [
    { id: 'lesson-01', title: 'Getting Started with Ethical Hacking', path: '/ethical-hacking/lesson-01' },
    { id: 'lesson-02', title: 'Network Reconnaissance', path: '/ethical-hacking/lesson-02' },
    { id: 'lesson-03', title: 'Network Discovery', path: '/ethical-hacking/lesson-03' },
    { id: 'lesson-04', title: 'Vulnerability Assessment', path: '/ethical-hacking/lesson-04' },
    { id: 'lesson-05', title: 'Web Application Security', path: '/ethical-hacking/lesson-05' },
    { id: 'lesson-06', title: 'Advanced Exploitation', path: '/ethical-hacking/lesson-06' },
    { id: 'lesson-cyberchef', title: 'CyberChef', path: '/ethical-hacking/cyberchef' },
    { id: 'lesson-fing', title: 'Fing', path: '/ethical-hacking/fing' },
    { id: 'lesson-password-attack', title: 'Password Attack & Hash Cracking', path: '/ethical-hacking/password-attack' },
    { id: 'lesson-phishing', title: 'Phishing Toolkit', path: '/ethical-hacking/phishing' }
  ]

  const binaryExploit = [
    { id: 'intro', title: 'Introduction to Buffer Overflow', path: '/binary-exploitation/intro' }
  ]

  const pythonHacking = [
    { id: 'mac-changer', title: 'Writing A MAC Address Changer', path: '/python-hacking/mac-changer' },
    { id: 'port-scanner', title: 'IP & Port Scanning', path: '/python-hacking/port-scanner' } 
  ]

  const pythonScripts = [
    // keep empty or add other script lessons here
  ]

  const toggleEthicalHacking = () => setIsEthicalHackingOpen(!isEthicalHackingOpen)
  const toggleBinaryExploit = () => setIsBinaryExploitOpen(!isBinaryExploitOpen)
  const togglePythonHacking = () => setIsPythonHackingOpen(!isPythonHackingOpen)
  const togglePythonScripts = () => setIsPythonScriptsOpen(!isPythonScriptsOpen)
      ...
      <div className='dropdown-container'>
        ...
        {isEthicalHackingOpen && (
          <div className='dropdown-content'>
            {lessons.map((lesson) => (
              <Link key={lesson.id} to={lesson.path} className='lesson-item'>{lesson.title}</Link>
            ))}
          </div>
        )}
      </div>
    ...
    <Router>
      <div>
        <nav className='home-button'>
          <Link to="/" className='home-title-link'><h1 className='home-title'>hacking-tutorial</h1></Link>
        ...
        <Routes>
          ...
          <Route path="/python-hacking/port-scanner" element={<Portscanner />} />
